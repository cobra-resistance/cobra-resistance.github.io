...
<section style="display: flex; flex-direction: row; flex-wrap: wrap; justify-content: center; align-items:center">
	...
	<div style="flex-basis:65%;flex-grow:1;margin-left:20px;margin-right:20px">
		...
		<p align="center" style="margin-top:15px;margin-bottom:15px"><a href="/" title="Prepare For Change, follow The Event by clicking here" style="padding:15px 30px 15px 30px;color:#e00000;background-color:#ffc040;border:1px solid #000;border-radius:7px;text-decoration:none;box-shadow:0px 2px 4px rgba(0, 0, 0, 0.5)"><b>The Event</b></a></p>
